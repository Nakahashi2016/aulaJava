...
public class Terminal {
    public static void main(String[] args) {
        ...
        final String VERMELHO = "\u001B[31m";  // Cor vermelha para valores inválidos
        final String CIANO = "\u001B[36m";     // Cor ciano para destaque da saída final
        ...
        // Exibe o resultado final formatado com 2 casas decimais ('%.2f' para 2 casas decimais)
